...
import 'package:asicronia_flutter_app/services/mockapi.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Asincronía Flutter',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.lightBlue),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Asincronía Flutter'),
    );
  }
}
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildCircularButton(
                    2, Icons.directions_car, 'Button 2', Colors.orange),
                SizedBox(
                    height:
                        16.0), // Espacio entre el botón y el texto (ajusta según tus necesidades)
                Text(
                ...
                SizedBox(
                    height:
                        30.0), // Espacio entre el texto y el siguiente botón (ajusta según tus necesidades)
                _buildCircularButton(
                    3, Icons.directions_walk, 'Button 3', Colors.red),
                SizedBox(
                    height:
                        16.0), // Espacio entre el botón y el texto (ajusta según tus necesidades)
                Text(
